...
namespace BasicCRM.Controllers.AdminControllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "UserID,FirstName,LastName,Email,Password,UserStatusId,UserTypeId,LessonId,RegistationDate,HireDate,FireDate")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "UserID,FirstName,LastName,Email,Password,UserStatusId,UserTypeId,LessonId,RegistationDate,HireDate,FireDate")] User user)
        {
            if (ModelState.IsValid)
            {
